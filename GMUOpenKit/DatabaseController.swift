...
public class WOPDatabaseController {
	...
	public static func getConfig() -> Realm.Configuration {
		...
		let fileURL = FileManager.default
			.containerURL(forSecurityApplicationGroupIdentifier: "group.com.halliecharley.gmusopen.app")?.appendingPathComponent("Library/Application Support/", isDirectory: true)
		config.fileURL = fileURL!.deletingLastPathComponent().appendingPathComponent("gumopen.realm")
		#endif
	...
	public static func getDefaults() -> UserDefaults {
		#if APPSTORE
		return UserDefaults.init(suiteName: "group.com.halliecharley.gmusopen.app")!
		#else
